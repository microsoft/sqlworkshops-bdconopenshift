...
The "Workshop: Architecting SQL Server Big Data Cluster Solutions on Red Hat OpenShift" workshop is taught using the following components, which you will create and configure in the sections that follow. 
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">Option 1 - Free Account</p>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">Option 2 - Microsoft Visual Studio Account Account</p>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">Option 3 - Use Your Own Account</p>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">Option 4 - Use an account provided by your instructor</p>
...
For this workshop, you will use Microsoft Windows as the base workstation, altough Apple and Linux operating systems can be used in production. 
 ...
 - You can <a href="https://developer.microsoft.com/en-us/windows/downloads/virtual-machines" target="_blank">download a Windows 10 Workstation Image for VirtualBox, Hyper-V, VMWare, or Parallels for free here</a>. 
