...
<img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/textbubble.png"> <h2>5.3 Credit Card Fraud Detection with Open Data Hub</h2>

In this section, you'll learn how to deploy Open Data Hub in your OpenShift environment, and use some of the tools it provides to implement a Fraud Detection use case scenario, based on the model you trained in the other parts of this workshop.
...
* This workflow is fully instumented with Prometheus, and Grafana dashboards display transaction flows, classifications, model performance, and other metrics

This wsection will guide you through the implementation of all these elements.
